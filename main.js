...
• Если ты еще не сделал несколько кнопок в игре — сейчас самое время.

• После того как напишешь подсчет нажатий на кнопку, доработай функцию так, чтобы каждая кнопка имела ограниченное количество нажатий. Например, не более 6 раз. Это тоже делается при помощи функции замыкания.
